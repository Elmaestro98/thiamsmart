...
import { emptyCart } from "@/images/banner";
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -top-4 -right-4 bg-shop_light_brown/85 rounded-full p-2"
          >
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">
            ...
            Changeons cela et trouvons des produits incroyables pour vous !
          </p>
        </div>
