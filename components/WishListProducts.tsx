...
const WishListProducts = () => {
  ...
  const handleResetWishlist = () => {
    const confirmReset = window.confirm(
      "Êtes-vous sûr de vouloir réinitialiser votre liste de favoris ?",
    );

    if (confirmReset) {
      resetFavorite();
      toast.success("Liste des favoris réinitialisée avec succès");
    }
  };
            ...
            <table className="w-full border-collapse">
              <thead className="border-b">
                <tr className="bg-black/5">
                  ...
                  <th className="p-2 text-left hidden md:table-cell capitalize">
                    Catégorie
                  </th>
        ...
        <div className="flex min-h-[400px] flex-col items-center justify-center space-y-6 px-4 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Les articles que vous ajoutez à vos favoris apparaîtront ici !
            </p>
          </div>
          <Button asChild>
