...
const BrandProducts = ({ slug, brandName, categories = [] }: Props) => {
    ...
    const fetchProducts = async () => {
      ...
      try {
        const categoryFilter = selectedCategory
          ...
          : "";
        const query = `
          *[_type == 'product' && references(*[_type == "brand" && slug.current == $brandSlug]._id) ${categoryFilter}] | order(name asc){
          ...,
        ...
        `;
        const params: Record<string, string> = { brandSlug: slug };
