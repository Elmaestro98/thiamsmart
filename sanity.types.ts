...
export type Product = {
  ...
  status?: "nouveau" | "tendance" | "promotion";
...
// Query: *[_type=='brand'] | order(name asc) {  ...,  "productCount": count(*[_type == "product" && references(^._id)])}
...
// Query: *[_type == 'product' && status == 'promotion'] | order(name asc){    ...,"categories": categories[]->title  }
...
export type PRODUCT_BY_SLUG_QUERY_RESULT = {
  ...
  status?: "nouveau" | "promotion" | "tendance";
  variant?: "appliances" | "gadget" | "others" | "refrigerators";
  isFeatured?: boolean;
} | null;
